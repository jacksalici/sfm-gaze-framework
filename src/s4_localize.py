...
def localize(query, images, model_parent):
    ...
    model = Reconstruction(model_parent / "sfm")
...
if __name__ == '__main__':
    ...
    query = '/Users/jacksalici/_aria-recordings/test2/eefe8b19-f09f-43b2-84a4-5da6eeed91c8/img0rgb.jpg'
    
    localize(query, images, outputs)